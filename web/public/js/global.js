...
//        if($(".filter-activator[name=naissance]").is(':checked')){
//            filters["event"]["naissance"] = "true";
//        }
//        else{
//            filters["event"]["naissance"] = "false";
//        }
//        
//        if($(".filter-activator[name=mort]").is(':checked')){
//            filters["event"]["mort"] = "true";
//        }
//        else{
//            filters["event"]["mort"] = "false";
//        }
        
//        $(".circular").addClass("circular-open");
        ...
        $.ajax({
            url: 'get-persons-ajax/' + years_splitted[ 0 ] + '/' + years_splitted[ 1 ],
                ...
                data: filters,
                complete: function(){
//                    $(".circular").removeClass("circular-open");
